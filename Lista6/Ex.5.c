...
int main()
{
    ...
    int M[4][6], soma2l=0, soma5c=0, somamult=0, somacolunapar=0, somalinhaimpar=0, maior=-10, menor=10;
    srand(time(0));
    for(int i = 0; i < 4; i++)
    {
        for(int j = 0; j < 6; j++)
    ...
    printf("F) Maior valor da matriz: %d\n", maior);
    printf("G) Menor valor da matriz: %d", menor);
